...
class DailyDigestEmail:
    ...
    def __init__(self):
        ...
        self.recipients_list = ['quantam00000@gmail.com',
                                'tanishasarkar0806@gmail.com']

        self.sender_credentials = {'email': os.getenv('SENDER_EMAIL'), # your sender email address
                                   'password': os.getenv('SENDER_PASS')} # your sender password
